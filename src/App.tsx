  ...
  <span className="text-[8px] font-sans text-stone-400 mt-0.5">
    {p.zhi}宮
              ...
              <div id="report-section" className="bg-white border border-[#EBE3D5] p-6 md:p-9 shadow-[0_8px_30px_rgba(140,122,107,0.02)] relative overflow-hidden rounded-3xl">
                ...
                {/* 分頁頁籤 */}
                <div className="flex overflow-x-auto whitespace-nowrap scrollbar-none pb-2 mb-6 border-b border-[#EBE3D5] font-serif">
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`py-2.5 px-4 lg:px-5 border-b-2 text-xs md:text-sm transition-all flex items-center space-x-2 cursor-pointer mr-2 rounded-t-xl font-serif ${
                          isActive
                ...
                <div className="bg-[#FAF8F6] rounded-2xl p-5 md:p-8 border border-[#EBE4D5] min-h-[220px] shadow-inner select-text">
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div className="font-serif leading-relaxed text-[#4E473F] text-xs md:text-[14px] antialiased px-1 text-left">
        ...
        <div style={{ position: "fixed", left: "0px", top: "0px", width: "794px", zIndex: -9999, pointerEvents: "none" }}>
          ...
          >
            ...
            <div className="space-y-3.5 text-left bg-white border border-[#E9DFCB] rounded-2xl p-6 shadow-xs relative">
              ...
              <div className="text-xs md:text-[13px] leading-relaxed text-[#544A42] font-serif antialiased space-y-2">
